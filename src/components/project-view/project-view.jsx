        ...
        <Col>
          <Card className="grid__item">
            ...
            <div className="card-body">
              ...
              <ul>
                <li>
                  Users are able to view a list of data and see more details for
                  a given data item on demand.
                </li>
                ...
                <li>
                  ...
                  architecture of a JavaScript app, as well as how I test and
                  debug my code.
                </li>
              </ul>
              <Button
          ...
          <Card className="grid__item">
            ...
            <div className="card-body">
              ...
              <ul>
                ...
                <li>
                  Utilized data visualization techniques to display event data
                  in the form of charts and graphs
                </li>
                <li>
                  Incorporated serverless functions hosted by a cloud provider
          ...
          <Card className="grid__item">
            ...
            <div className="card-body">
              ...
              <ul>
                ...
                <li>
                  Users are able to sign up, update their personal information,
                ...
                <li>
                  The application is hosted online and is responsive, providing
                  the same user experience on any device.
                </li>
                <li>
                  Movie enthusiasts have access to information about different
                  movies, directors, and genres and be able to save data about
            ...
            <div className="card-body">
              ...
              <ul>
                <li>
                  ...
                  NixFlix based on its existing server-side code (REST API and
                  database).
                </li>
                <li>
                  I created the interface for the NixFlix app that users can use
                  to make requests to and receive responses from the
                  server-side.
                </li>
                <li>
                  It considers the readability and maintenance of the codebase,
                  and the design and usability of the app.
                </li>
                <li>
                ...
                <li>
                  ...
                  anywhere and on any device, giving all users the same
                  experience.
                </li>
                <li>
          ...
          <Card className="grid__item">
            ...
            <div className="card-body">
              ...
              <ul>
                ...
                <li>
                  I used React Native, Expo, and Google Firestore Database to
                  build a chat app that can be added to a portfolio to
                  demonstrate knowledge of JavaScript mobile development.
                </li>
                <li>
                  The app is optimized for both Android and iOS devices and can
                  be used by other developers working on the product.
                </li>
                <li>
                  The app features a page where users can enter their name and
                  choose a background color for the chat screen before joining
                  the chat, a page displaying the conversation, input field and
                  submit button, and options to send images and location data.
                </li>
                <li>
